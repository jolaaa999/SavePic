    ...
    <nav class="flex-1 space-y-0.5 overflow-y-auto px-3 py-3">
      ...
      >
        ...
        <span class="flex items-center gap-2">
          ...
          <button
            type="button"
            class="rounded-lg p-1.5 text-zinc-600 active:bg-white/10 active:text-zinc-300"
            title="重命名分类"
            aria-label="重命名分类"
          ...
          <button
            type="button"
            class="rounded-lg p-1.5 text-zinc-600 active:bg-red-500/15 active:text-red-400"
            title="删除分类"
            aria-label="删除分类"
